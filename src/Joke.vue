  ...
  <div class="container">
      <div class="joke">
        ...
        <div class="joke__likes">
          <button id="btn-up" class="btn-like btn-like--up" @click="like"></button>
          <span id="likes-up" class="likes-count likes-count--up">{{likes}}</span>
          <button id="btn-down" class="btn-like btn-like--down" @click="downLike"></button>
...
export default {
  ...
  methods: {
  like() {
      this.$emit("like", this.idx);
    },
    downLike () {
      this.$emit("downLike", this.idx);
    }
  }
